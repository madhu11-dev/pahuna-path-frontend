...
import { createPlaceReview, getPlace, getPlaceReviews } from "../apis/Api";
...
const PlaceDetailModal = ({ placeId, isOpen, onClose }) => {
  ...
  const handleFindAccommodation = () => {
    ...
    // Navigate to accommodations page with place location parameters
  ...
  const images = Array.isArray(place.images)
    ? place.images.map(resolveImageUrl)
    : [];
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-700">
                  Shared by {place.user?.name || "Anonymous"}
                </span>
              </div>
